...
const RainMotion = styled.div`
    position: absolute; top:-20px; left:-50px; width:300px; height:70px; background:#888 url("/static/media/rainbow.301ab06335eeb7f1c486.gif") no-repeat 0 0; background-size: cover; filter: blur(10px); -webkit-filter: blur(10px); z-index: 10;
`
